...
module.exports = class walletNode extends EventEmitter {
  constructor (nodeAddress, readyCallback) {
    ...
    const packageDefinition = protoLoader.loadSync(__dirname + '/../protos/dmgcoinwalletd.proto', {
      keepCase: true,
      longs: String,
      enums: String,
      defaults: true,
      oneofs: true
		...
		const { dmgcoinwalletd } = gRPC.loadPackageDefinition(packageDefinition).dmgcoinwalletd

    this._client = new dmgcoinwalletd(nodeAddress, gRPC.credentials.createInsecure(), {  
